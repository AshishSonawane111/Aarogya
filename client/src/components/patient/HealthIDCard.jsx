...
export const HealthIDCard = ({ patient, healthId, emergencyProfile }) => {
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-900 via-teal-800 to-slate-900 text-white p-6 shadow-xl border border-teal-700/40">
        ...
        {/* Card Header */}
        <div className="flex items-center justify-between border-b border-teal-700/50 pb-4 mb-4">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-[11px] font-medium bg-teal-800/80 hover:bg-teal-700 text-teal-200 px-3 py-1 rounded-lg border border-teal-600/40 transition"
            >
          ...
          <div className="flex-1 text-center sm:text-left space-y-2">
            <div>
              ...
              <div className="font-mono text-sm font-semibold text-teal-300 flex items-center justify-center sm:justify-start gap-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-2 text-xs">
              <div className="bg-slate-900/60 p-2 rounded-xl border border-teal-800/40">
                <span className="text-[10px] uppercase text-teal-400 block font-semibold">Blood Group</span>
              ...
              <div className="bg-slate-900/60 p-2 rounded-xl border border-teal-800/40">
                <span className="text-[10px] uppercase text-teal-400 block font-semibold">Emergency Contact</span>
              ...
              <div className="bg-slate-900/60 p-2 rounded-xl border border-teal-800/40 col-span-2 sm:col-span-1">
                <span className="text-[10px] uppercase text-teal-400 block font-semibold">Known Allergies</span>
          ...
          >
            <QRCodeSVG
              value={`HP:${patient?.first_name}_${patient?.last_name}:${healthIdNumber}`}
              size={68}
              level="M"
            />
        ...
        {/* Footer Note */}
        <div className="mt-4 pt-3 border-t border-teal-700/40 flex flex-col sm:flex-row items-center justify-between text-[11px] text-teal-200/80 gap-2">
          <span>Protected by Multi-Factor Row-Level Security</span>
          <button
            onClick={() => setShowQRModal(true)}
            className="text-white hover:text-teal-300 font-semibold underline flex items-center gap-1"
          >
