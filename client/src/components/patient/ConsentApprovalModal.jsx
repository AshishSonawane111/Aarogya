      ...
      <div className="space-y-4">
        ...
        <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-teal-700 font-medium">{consent.specialization}</div>
        ...
        <div>
          ...
          <div className="p-3 bg-teal-50/50 rounded-xl border border-teal-200 text-xs text-slate-800 italic">
            "{consent.reason}"
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 py-2.5 px-4 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-md shadow-teal-600/20 transition"
          >
