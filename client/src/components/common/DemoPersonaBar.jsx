        ...
        <div className="flex items-center gap-1.5 overflow-x-auto py-0.5">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1 bg-slate-800 hover:bg-slate-700 text-teal-300 px-2 py-0.5 rounded text-[11px] font-medium border border-slate-700 transition"
            >
              All Personas
            ...
            {isOpen && (
              <div className="absolute right-0 mt-2 w-72 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl p-3 z-50 animate-in fade-in-50">
                <div className="text-slate-400 font-semibold text-[10px] uppercase tracking-wider mb-2 flex items-center gap-1">
                  <UserCheck className="w-3 h-3 text-teal-400" /> Demo Patients (5)
                </div>
