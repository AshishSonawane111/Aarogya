      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {loading ? (
          ...
          <div className="col-span-2 bg-white p-12 rounded-2xl border border-slate-200 text-center space-y-3">
            ...
            <button
              onClick={() => setShowBookModal(true)}
              className="px-4 py-2 rounded-xl bg-sky-600 text-white text-xs font-bold inline-flex items-center gap-1.5 shadow-sm"
            >
          ...
          appointments.map((apt) => (
            ...
            >
              <div className="flex items-start justify-between gap-3 border-b border-slate-100 pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-sky-700 font-semibold">{apt.specialization}</div>
              ...
              {/* Chief complaint */}
              <div className="text-xs text-slate-600 bg-sky-50/40 p-2.5 rounded-xl border border-sky-100">
                <span className="font-bold text-sky-900">Reason: </span>
        ...
        <form onSubmit={handleBookSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              {checkingSlots && (
                <span className="text-[10px] text-sky-600 font-semibold animate-pulse">
                  Checking Engine...
                </span>
              )}
            </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 py-2.5 px-4 rounded-xl bg-sky-600 hover:bg-sky-700 disabled:opacity-50 text-white text-xs font-bold shadow-md shadow-sky-600/20"
            >
