    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-teal-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-teal-600 block font-semibold uppercase tracking-wider">
          ...
          <div className="hidden md:flex items-center gap-6 text-xs font-semibold text-slate-600">
            ...
            <a href="#patient-benefits" className="hover:text-teal-600 transition">Patients</a>
            <a href="#doctor-benefits" className="hover:text-teal-600 transition">Doctors & Hospitals</a>
            <a href="#ai-intelligence" className="hover:text-teal-600 transition">AI & Translation</a>
            <a href="#consent-security" className="hover:text-teal-600 transition">Zero-Trust Privacy</a>
          </div>
      ...
      <section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28 gradient-mesh">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-50 border border-teal-200 text-teal-800 text-xs font-bold uppercase tracking-wider mb-6 shadow-xs animate-in fade-in-50">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight max-w-4xl mx-auto leading-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-600 via-teal-500 to-indigo-600">
              Your Control.
            </span>
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 max-w-md mx-auto">
            <Link
              to="/auth/patient"
              className="w-full sm:w-auto px-7 py-3.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm shadow-lg shadow-teal-600/30 flex items-center justify-center gap-2 transition"
            >
          ...
          <div className="mt-14 max-w-4xl mx-auto bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xl text-left">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4 mb-6">
              <div>
                <span className="text-[11px] uppercase font-bold text-teal-600 tracking-wider">
              ...
              {selectedRole === 'patient'
                ? personas.patients?.map((p) => (
                    <div
                      ...
                      className="p-4 rounded-2xl border border-slate-200 hover:border-teal-400 hover:bg-teal-50/40 cursor-pointer transition flex items-center gap-3 group bg-white shadow-xs"
                    >
                      <img
                        src={p.avatarUrl}
                        alt={p.name}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-bold text-sm text-slate-900 truncate group-hover:text-teal-700">
                          {p.name}
                        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative">
            {[
              ...
              return (
                <div
                  key={idx}
                  className="bg-slate-50 p-6 rounded-2xl border border-slate-200 relative group hover:border-teal-500 hover:bg-teal-50/20 transition shadow-xs"
                >
                  <div className="text-2xl font-black text-slate-300 group-hover:text-teal-400 transition">
                    {item.step}
                  </div>
                  <div className="w-10 h-10 rounded-xl bg-teal-600/10 text-teal-600 flex items-center justify-center my-3">
      ...
      <section id="patient-benefits" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-teal-900 via-teal-800 to-slate-900 text-white p-8 rounded-3xl shadow-2xl border border-teal-700/50 relative overflow-hidden">
              ...
              <div className="space-y-4 text-xs">
                <div className="bg-slate-900/60 p-4 rounded-2xl border border-teal-800/40">
                  <div className="text-teal-300 text-[10px] uppercase font-bold">Patient Name</div>
                  <div className="text-base font-bold text-white">Rajesh Kumar</div>
                  <div className="text-teal-400 font-mono text-xs">HP-2026-1001</div>
                </div>

                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-slate-900/60 p-3 rounded-xl border border-teal-800/40">
                    <span className="text-teal-300 text-[10px] uppercase block font-semibold">Blood Group</span>
                    <span className="font-bold text-white text-sm">B+ Positive</span>
                  </div>
                  <div className="bg-slate-900/60 p-3 rounded-xl border border-teal-800/40">
                    <span className="text-teal-300 text-[10px] uppercase block font-semibold">Allergies</span>
                    <span className="font-bold text-amber-300 text-sm">Penicillin, Peanuts</span>
                  </div>
                </div>

                <div className="p-3 bg-teal-800/30 rounded-xl border border-teal-700/40 text-[11px] text-teal-200">
